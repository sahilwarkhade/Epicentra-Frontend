...
const ProfilePage = () => {
    ...
    const getBlogs = ({page=1,user_id}) => {
        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN+"/search-blogs",{
            ...
            let formatedDate=await filterPaginetionData({
                state:blogs,
                data:data.blogs,
                page,
                ...
                <section className='h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12'>
                    <div className='flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-10'>
                        ...
                        <div className='flex gap-4 mt-2'>
                            {
                                profileId==username ?
                                <Link className='btn-light rounded-md' to={'/setting/edit-profilee'}>Edit Profile</Link>
                                :""
                            }
                        </div>

                        <AboutUser className={""} bio={bio} social_links={social_links} joinedAt={joinedAt}></AboutUser>
